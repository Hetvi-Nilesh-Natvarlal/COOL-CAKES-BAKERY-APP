...
public class TodayDeliveryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_today_delivery);

        recyclerView = (RecyclerView) findViewById(R.id.rectodaydel);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));


        Calendar callfordate= Calendar.getInstance();
        //SimpleDateFormat currentdate= new SimpleDateFormat("EEEE, dd MMMM, yyyy");
        ...
        ref.orderByChild("date").equalTo(savecurrentdate.toString()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot snapshot1:snapshot.getChildren())
                {
                        ...
                        if(productsconfirm.getOrderstate().equals("Confirmed")) {
