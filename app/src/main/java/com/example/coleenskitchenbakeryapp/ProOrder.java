...
public class ProOrder {
    ...
    String date,desc_enter,devprice,flavours,img_url,pid,pname,price,quantity,time,uid,wordings;

    public ProOrder() {
    }

    public ProOrder(String date, String desc_enter, String devprice, String flavours, String img_url, String pid, String pname, String price, String quantity, String time, String uid, String wordings) {
        this.date = date;
